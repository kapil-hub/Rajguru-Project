    ...
    <div style="max-width:680px;margin:0 auto;padding:24px;">
        <div style="background:#ffffff;border:1px solid #e5e7eb;border-radius:10px;overflow:hidden;">
            <div style="padding:20px 24px;border-top:5px solid {{ $accent }};">
                <h1 style="margin:0;font-size:20px;color:#111827;">Late Held Class Request</h1>
            ...
            <div style="padding:0 24px 24px;">
                ...
                @if($mailType === 'pending_approval')
                    <p style="font-size:15px;line-height:1.6;">
                        {{ $senderName }} has submitted a late held-class request for your review.
                    </p>
                @elseif($mailType === 'approved')
                    <p style="font-size:15px;line-height:1.6;">
                        Your late held-class request has been approved. The associated held count has been added to the pool.
                    </p>
                @else
                    <p style="font-size:15px;line-height:1.6;">
                        Your late held-class request has been rejected.
                    </p>
                @endif
