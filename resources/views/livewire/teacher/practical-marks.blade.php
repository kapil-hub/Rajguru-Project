<div>
    ...
    <div class="bg-white rounded-2xl shadow-md p-6 mb-6 border-l-8 border-indigo-600">
        ...
        <div class="mt-4">
            ...
            <select wire:model.live="selectedPaper" class="w-half mt-2 p-3 rounded-xl border border-gray-300
            ...
            <button wire:click="loadStudents" wire:loading.attr="disabled" wire:target="loadStudents"
                @disabled(!$selectedPaper) class="mt-4 px-6 py-2 bg-indigo-600 text-white
                        ...
                        <tr>
                            ...
                            @if($this->isOnlyTotal())
                                <th class="px-4 py-3 text-center">
                                    Practical Total <br>(max: <b>{{$practicleBreakup['total']}}</b>)
                                </th>
                                <th class="px-4 py-3 text-center">
