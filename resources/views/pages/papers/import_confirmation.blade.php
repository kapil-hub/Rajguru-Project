                ...
                <table class="min-w-full border">
                    <thead class="bg-red-50">
                        <tr>
                            ...
                            <th class="border px-3 py-2">Eligibilty</th>
                            <th class="border px-3 py-2">Prereqisites</th>
                            <th class="border px-3 py-2">Capping</th>
                    ...
                    <tbody>
                        @foreach($invalidRows as $row)
                            <tr class="bg-red-50">
                                ...
                                <td class="border px-3 py-2">{{ $row['data']['eligibilty'] ?? '-' }}</td>
                                <td class="border px-3 py-2">{{ $row['data']['prereqisites'] ?? '-' }}</td>
                                <td class="border px-3 py-2">{{ $row['data']['capping'] ?? '-' }}</td>
                                <td class="border px-3 py-2">{{ $row['data']['remark'] ?? '-' }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
